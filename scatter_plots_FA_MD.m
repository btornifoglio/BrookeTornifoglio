...
figure()
scatter(md, fa, 10,'x','g')
grid on
xticks([0.0004 0.0008]);yticks([.15 .3 .5]);
ylabel('FA');xlabel('MD (mm^2/s)')
...
hold on
scatter(md_2, fa_2,10,'x','r')
grid on
xticks([0.0004 0.0008]);yticks([.15 .3 .5]);
ylabel('FA');xlabel('MD (mm^2/s)')
xlim([0 3e-3]); ylim([0 1])
set(gca,'FontSize',15)
legend('Thickened intima','Fibrous media')
%%
hold on
scatter(md_3, fa_3, 10,'x','y')
grid on
xticks([0.0004 0.0008]);yticks([.15 .3 .5]);
ylabel('FA');xlabel('MD (mm^2/s)')
xlim([0 3e-3]); ylim([0 1])
set(gca,'FontSize',15)
legend('Lipid core','Fibrous media','Fibrous cap')
%%
hold on
...
xlim([0 3e-3]); ylim([0 1])
set(gca,'FontSize',15)
% legend( 'Native', 'Decellularised', 'Collagenase treated', 'Elastase treated')
